const projects = [
  {
    ...
    "repoUrl": "https://github.com/mariam-kanj/mariam-portfolio",
  ...
  },
  {
    id: 'proj-3',
    title: 'Yalla Match',
    description: 'A comprehensive pet adoption platform that brings people and pets together. Features include pet browsing, matching quizzes, community engagement, and appointment scheduling.',
    tech: ['React', 'Node.js', 'Express', 'MySQL', 'JWT Auth'],
    repoUrl: 'https://github.com/maryamkanj/Yalla-Match.git',
    image: '/images/yallaMatch.png',
    features: [
